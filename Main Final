...
# =============================================================================
        """
#        self.actualizar_button = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
##        self.actualizar_button.setGeometry(QtCore.QRect(1417, 945, 93, 28))
#        self.actualizar_button.setMinimumSize(QtCore.QSize(93, 28))
#        self.actualizar_button.setMaximumSize(QtCore.QSize(93, 28))
#        self.actualizar_button.setText('Actualizar')
##        self.actualizar_button.setObjectName("actualizar_button")
##        self.actualizar_button.raise_()
#        self.gridLayout.addWidget(self.actualizar_button, 26, 3, 1, 2)
...
#            self.mrcsumb=str(self.mrcsumb)
            ...
            for i in indexbo:
                nordenb = self.tabla_base.item(i-3, 3)
                self.nordenb = nordenb.text()
                if self.nordensf == self.nordenb:
                    if len(indexbo) == 1:
                        mrcsumb = self.tabla_base.item(i-3, 8)
                        self.mrcsumb = mrcsumb.text()
                        self.nordenb = nordenb.text()
                    elif len(indexfo) > 1:            
                        self.mrcsumb=0
                        for j in range (len(indexbo)):
                            valor = float(self.datab[indexbo[j]][8])
...
#                            print('norden igual')
                            ...
                            if mrc_sf == mrc_f:
                                ...
                                if y==1:
                                    ...
                                    correctos_y.append(''); correctos_y.append(id_sf); correctos_y.append(''); correctos_y.append(norden_sf); correctos_y.append(operador_sf)
                                    ...
                                    correctos_y.append(''); correctos_y.append(''); correctos_y.append(''); correctos_y.append(''); correctos_y.append(''); correctos_y.append('');
...
#                            print(correctos)
    ...
    #                            print(correctos)
        ...
        self.pop3.setObjectName("Inorrectos")
        self.pop3.show()
...
#        print(base)
        ...
        self.tabla_base.setRowCount(len(base)-1)
        ...
        for i in range(len(base)):
            for j in range(len(base[0])):
                if i == 0:
                    self.tabla_base.setHorizontalHeaderItem(j, QtWidgets.QTableWidgetItem(str(base[i][j])))
                elif i>0:
                    valor = str(str(base[i][j]))
                    nvalor = QtWidgets.QTableWidgetItem(valor)
                    self.tabla_base.setItem(i-1,j, nvalor)
        self.tabla_base.resizeColumnsToContents()
...
#        self.exp_base_2()
        font.bold =True
        style.font = font
        self.sheet.write(0, 0, 'R', style=style); self.sheet.write(0, 1, 'ID', style=style); self.sheet.write(0, 2, 'GP', style=style);self.sheet.write(0, 3, '# Order', style=style); self.sheet.write(0, 4, 'Operador', style=style)
        self.sheet.write(0, 5, 'Pais', style=style); self.sheet.write(0, 6, 'Estado', style=style); self.sheet.write(0, 7, 'BW', style=style)
        self.sheet.write(0, 8, 'MRC', style=style); self.sheet.write(0, 9, 'Currency', style=style); 
        self.sheet.write(0, 10, 'Pais', style=style); self.sheet.write(0, 11, 'BW', style=style); self.sheet.write(0, 12, 'MRC', style=style); self.sheet.write(0, 13, 'Currency', style=style); self.sheet.write(0, 14, 'Estado', style=style)
        self.sheet.write(0, 15, 'Pais Z', style=style); self.sheet.write(0, 16, 'Dirección Z', style=style); self.sheet.write(0, 17, 'Estado Servicio', style=style); self.sheet.write(0, 18, 'BW', style=style)
        self.sheet.write(0, 19, '', style=style); self.sheet.write(0, 20, '', style=style);
        self.sheet.write(0, 21, 'Diferencia', style=style); self.sheet.write(0, 22, 'Fecha Inicio', style=style)
        self.sheet.write(0, 23, 'Termino', style=style); self.sheet.write(0, 24, 'Fecha Fin', style=style)
        self.sheet.write(0, 25, '', style=style); self.sheet.write(0, 26, 'ID Tercero', style=style); self.sheet.write(0, 27, 'Valor Tercero', style=style);
